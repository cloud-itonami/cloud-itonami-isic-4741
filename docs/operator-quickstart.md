# Operator Quickstart — Retail Sale of Computers, Peripheral Equipment and Software in Specialized Stores

Shortest path from clone to a verified local dry-run for **ISIC 4741** (`cloud-itonami-isic-4741`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4741.git
cd cloud-itonami-isic-4741
```
...
- Blueprint governor key: `retail-governor`
- Likely source path: `techretail.governor.cljc`
